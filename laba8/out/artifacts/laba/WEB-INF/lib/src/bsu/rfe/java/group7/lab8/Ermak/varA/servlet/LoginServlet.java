package bsu.rfe.java.group7.lab8.Ermak.varA.servlet;
...
import bsu.rfe.java.group7.lab8.Ermak.varA.entity.ChatMessage;
import bsu.rfe.java.group7.lab8.Ermak.varA.entity.ChatUser;
...
public class LoginServlet extends ChatServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        pw.println("<form action='/laba/' method='post'>Введите имя: <input type='text' name='name' value=''><input type='submit' value='Войти в чат'>");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse
        ...
        if (errorMessage!=null) {
            ...
            response.sendRedirect(response.encodeRedirectURL("/laba/"));
        }
    }
    ...
    String processLogonAttempt(String name, HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (aUser.getSessionId().equals(sessionId) ||
            ...
            response.sendRedirect(response.encodeRedirectURL("/laba/view.html"));
